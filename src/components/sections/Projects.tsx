        ...
        <div className="grid md:grid-cols-2 gap-8 max-h-[750px] overflow-y-auto pr-4">
          {projects.map((project, idx) => (
            <motion.div
              ...
              className="group relative bg-white/40 dark:bg-black/40 backdrop-blur-md border border-black/5 dark:border-white/10 rounded-2xl p-8 hover:bg-white/60 dark:hover:bg-black/60 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl flex flex-col h-full shadow-[0_4px_30px_rgba(0,0,0,0.05)] dark:shadow-[0_4px_30px_rgba(0,0,0,0.2)]"
            >
              <div className="flex justify-between items-start mb-6">
                <h3 className="text-2xl font-bold font-syne text-gray-900 dark:text-white group-hover:text-teal-600 dark:group-hover:text-teal-400 transition-colors">
                  {project.title}
                </h3>
